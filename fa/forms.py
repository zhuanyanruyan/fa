...
class LoginForm(forms.Form):
    ...
    # Form 默认required=True  attrs就是添加样式
    ...
    def clean(self):
        ...
        if user is None:
            ...
            self.cleaned_data['user'] = user  # 就是将user 返回过去，返回给views.py
...
class RegForm(forms.Form):
    ...
    def clean_username(self):   # clean_xxx 专门针对一个字段的
        username = self.cleaned_data['username']
